    ...
    P.widget("ui.draggable", P.ui.mouse, {
      ...
      _mouseStop: function (t) {
        ...
        return (
          ...
          (P.isFunction(this.options.revert) &&
    ...
    P.ui.plugin.add("draggable", "snap", {
      ...
      drag: function (t, e, s) {
        ...
        for (c = s.snapElements.length - 1; 0 <= c; c--)
          (a =
            (l = s.snapElements[c].left - s.margins.left) +
            s.snapElements[c].width),
            (p =
              (h = s.snapElements[c].top - s.margins.top) +
              s.snapElements[c].height),
            m < l - g ||
            a + g < u ||
            _ < h - g ||
            p + g < v ||
